...
|-------------|---------|-----------|
| "快速摸底" / "大致看看" | 浅层 | Phase 1 + 2 |
| "调研 XX 模块" | 标准 | Phase 1~5（限定模块范围） |
| "全面调研" / "完整盘点" | 深层 | Phase 1~5（全项目） |
| "聚焦业务规则" | 定向 | Phase 4 + 5（跳过结构和技术栈） |
...
### 下游：CI → PM
- CI 报告提交后，等待 CP-2 检查点（用户确认方向和关键决策）
- PM 基于 CI 报告制定方案，决定哪些候选规则需要人工确认
